...
namespace LeGarage.Infra.Migrations
{
    ...
    public partial class InitialCatalog : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProvidedServiceCategories",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProvidedServiceCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CapacityUnit = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    Notes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpeningHourse = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    Notes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubtotalLabor = table.Column<decimal>(type: "numeric", nullable: false),
                    SubtotalParts = table.Column<decimal>(type: "numeric", nullable: false),
                    SubtotalExternalServices = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ProvidedServiceCategoryId = table.Column<int>(type: "integer", nullable: false),
                    Name = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    PricingModel = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Rate = table.Column<decimal>(type: "numeric", nullable: false),
                    EstimatedHours = table.Column<decimal>(type: "numeric", maxLength: 50, nullable: false),
                    MinCharge = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProvidedServices_ProvidedServiceCategories_ProvidedServiceC~",
                        column: x => x.ProvidedServiceCategoryId,
                        principalTable: "ProvidedServiceCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SparePartCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Name = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkOrderRecord = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Mileage = table.Column<int>(type: "integer", nullable: false),
                    ...
                    ExternalServiceCost = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceptionReceipt = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockReplenishments_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockReplenishments_SpareParts_SparePartId",
                        column: x => x.SparePartId,
                        principalTable: "SpareParts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockReplenishments_Warehouses_WareHouseId",
                        column: x => x.WareHouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WarehouseStocks_SpareParts_SparePartId",
                        column: x => x.SparePartId,
                        principalTable: "SpareParts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BridgeId = table.Column<int>(type: "integer", nullable: false),
                    ProvidedServiceId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    PartsCost = table.Column<decimal>(type: "numeric", nullable: false),
                    ExternalServiceCost = table.Column<decimal>(type: "numeric", nullable: false),
                    TaskTotalCost = table.Column<decimal>(type: "numeric", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    Notes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Jobs_Bridges_BridgeId",
                        column: x => x.BridgeId,
                        principalTable: "Bridges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Jobs_ProvidedServices_ProvidedServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    EndTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PauseDuration = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PauseRecords_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "TaskExternalServiceUsages",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TaskId = table.Column<int>(type: "integer", nullable: false),
                    ExternelServiceId = table.Column<int>(type: "integer", nullable: false),
                    ProviderId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskExternalServiceUsages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskExternalServiceUsages_ExternalServices_ExternelServiceId",
                        column: x => x.ExternelServiceId,
                        principalTable: "ExternalServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskExternalServiceUsages_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TaskExternalServiceUsages_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPartCost = table.Column<decimal>(type: "numeric", nullable: false),
                    DeliveryNote = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    JobId = table.Column<int>(type: "integer", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    Notes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskPartUsages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskPartUsages_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TaskPartUsages_SpareParts_SparePartId",
                        column: x => x.SparePartId,
                        principalTable: "SpareParts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskPartUsages_Warehouses_WarehouseId",
                        column: x => x.WarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Jobs_BridgeId",
                table: "Jobs",
                column: "BridgeId");

            migrationBuilder.CreateIndex(
                name: "IX_Jobs_ProvidedServiceId",
                table: "Jobs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PauseRecords_JobId",
                table: "PauseRecords",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_ProvidedServices_ProvidedServiceCategoryId",
                table: "ProvidedServices",
                column: "ProvidedServiceCategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockReplenishments_ProviderId",
                table: "StockReplenishments",
                column: "ProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_StockReplenishments_SparePartId",
                table: "StockReplenishments",
                column: "SparePartId");

            migrationBuilder.CreateIndex(
                name: "IX_StockReplenishments_WareHouseId",
                table: "StockReplenishments",
                column: "WareHouseId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskExternalServiceUsages_ExternelServiceId",
                table: "TaskExternalServiceUsages",
                column: "ExternelServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskExternalServiceUsages_JobId",
                table: "TaskExternalServiceUsages",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskExternalServiceUsages_ProviderId",
                table: "TaskExternalServiceUsages",
                column: "ProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskPartUsages_JobId",
                table: "TaskPartUsages",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskPartUsages_SparePartId",
                table: "TaskPartUsages",
                column: "SparePartId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskPartUsages_WarehouseId",
                table: "TaskPartUsages",
                column: "WarehouseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseStocks_SparePartId",
